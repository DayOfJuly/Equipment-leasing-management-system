...
<div class="container">
		...
		<div class="navbar-inner" style="height: 39px">
			<div class="container">
				<div class="navbar-header text-center col-xs-12">
					<h4>
						<a href="/WebSite/Mobile/Index.jsp#/Infopubpublish"><small><span class="glyphicon glyphicon-chevron-left pull-left" style="color: #fff"></span></small></a>
    ...
    <div class="col-md-12 column" style="margin-top:20%" align="center">
       <span><a href="/WebSite/Mobile/Index.jsp#/Infopubpublish"><button type="button" class="btn btn-default btn-sm" style="margin-left: 10px;width: 30%">返回</button></span>
    </div>
</div>
