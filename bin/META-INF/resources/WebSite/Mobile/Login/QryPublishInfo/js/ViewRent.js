app.controller('ViewRentController', function ($scope,$timeout,$route,$interval,rentSvc,SaleSvc,PicSvc,published,regionSvc,busDealInfo,busPublishInfo,PicUrl,SYS_CODE_CON,sysCodeTranslateFactory,IssuSvc) {
	 ...
	 $scope.back = function(){
		 if($route.current.params.numb==1){
         	...
         	var urlStr = "/WebSite/Mobile/Index.jsp#/viewRentList/1";
				window.location.href = urlStr; 
		 }
	 }
