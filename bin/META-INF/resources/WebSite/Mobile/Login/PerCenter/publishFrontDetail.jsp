...
<div ng-controller="publishFrontDetailController" class="container">
				...
				<div class="row">
					<div class="text-center col-xs-12">						
						<h4 style="font-size:18px">
							<a href="/WebSite/Mobile/Index.jsp#/publishFrontList">
...
<!--        <span><button type="button" class="btn btn-default btn-sm" ng-click="delPublish_(equList.id);" style="margin-left: 10px;width: 30%">删除</button></span> -->
<!--     </div> -->
</div>
</html>