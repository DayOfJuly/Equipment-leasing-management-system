	...
	<div class="modal-dialog" >
		<div class="modal-content" style="margin-left: -10px;">
			...
			<div class="modal-body">
				<div class="form-horizontal" style="margin-top: 30px;">
					...
					<div class="form-group" >
						<div class="col-xs-12" >						
				     		<span>当前位置：<a ng-repeat="p in equAtEmployers" ng-click="clickEquAtEmployers(1,p,$index)"><span ng-show="p.orgFlag!=9">&gt;&gt;</span><span>{{p.name}}</span></a></span>
						</div>
					</div>
					<div class="form-group" >
			...
			<div class="modal-footer">
				<input type="button" class="btn btn_Under btn-primary" style="width: 50px;margin-top: -25px;" value="确定" ng-click="modifyEquAtEmployerModel()"/>
				<input type="button" class="btn btn_Under btn-danger" style=" width: 50px;margin-top: -25px;" value="清空" ng-click="clearEquAtEmployerModel()"/>
				<input type="button" class="btn btn_Under btn-default" style="width: 50px;margin-top: -25px;" value="取消" ng-click="closeEquAtEmployerModel()"/>
			</div>
		</div>
	</div>
</div>
