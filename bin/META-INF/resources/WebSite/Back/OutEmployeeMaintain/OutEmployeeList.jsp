...
<html lang="en">
	...
	<body>
		<div  class="container">
			...
			<div ng-include src="'./OutEmployeeMaintain/OutEmployeeAdd.jsp'"></div> 
			<div ng-include src="'./OutEmployeeMaintain/OutEmployeeDetail.jsp'"></div> 
			<div ng-include src="'./OutEmployeeMaintain/OutEmployeeUpdate.jsp'"></div> 
			<div ng-include src="'./OutEmployeeMaintain/OutEmployeeState.jsp'"></div> 
			
			<ol class="breadcrumb">
				<li style="font-size: 13px">您的位置：后台管理</li>
				<li style="font-size: 13px">外部企业用户</li>
				<li style="font-size: 13px">外部员工信息维护</li>
			</ol>
			
			<div style="width: 95%" autocomplete="off">
		 ...
		 -->							<input  id="purId" class="form-control" ng-model="formParm.fuzzyData" placeholder="查询 员工姓名、注册手机号码、企业名称" style="padding:0px -15px 0px 20px;"
					...
					<table class="table table-hover" style="margin: 10px 0px 0px 119px;width: 79%;">
			 		...
			 		<div style="margin-left: 3.3%;margin-top:-0.5%;">
						<div  style="text-align: right; float: right;height: 1px" ng-show="entityList.length>0">
							<tm-pagination conf="paginationConf" style="margin-left: -35%;"></tm-pagination>
						</div>
						<div style="margin-left: 5.3%; margin-top:1%;">
							<button ng-show="btnShow_"  type="button" class="btn btn-primary" ng-click="openCheckDetail(1)">查看</button>
							<button id="nb123"  type="button" class="btn btn-primary" ng-click="openAddEmployee()">添加</button>
