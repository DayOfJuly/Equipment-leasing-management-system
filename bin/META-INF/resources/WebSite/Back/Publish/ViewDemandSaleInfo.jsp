...
<script type="text/javascript">
        ...
        app.controller('viewDemanController', function ($scope, $timeout ,$interval, DemandRentSvc, DemandSaleSvc,personSvc, PicSvc,regionSvc,published,PicUrl,busDealInfo,SYS_CODE_CON,IssuSvc,sysCodeTranslateFactory) {
             ...
             $scope.querySimilar = function(){
            	 $scope.infoType = $scope.requestParms.infoType;
           		 function qSuc(rec) {
                	 ...
                	 function qErr(){}
                	 IssuSvc.post({Action:"DemandSale"},{dataType:$scope.infoType,equName:$scope.equName,pageNo:0,pageSize:10},qSucc,qErr);
            	 }
       ...
       <div class="">
         ...
         <div class="beft_top_rightr" style="margin-left:50px;">
           ...
           <div class="clear"></div>
             ...
             <!-- <ul class="uiigg" >
                <li style="border: 1px solid #CCC;"><span>设备名称：</span><font title="{{viewList.equName}}">{{viewList.equNameA}}</font></li>
                <li style="border: 1px solid #CCC;"><span>品牌：</span><font title="{{viewList.brandName}}" style="border-right:1px solid #CCC;">{{viewList.brandNameA}}</font></li>
                <li style="border-bottom: 1px solid #CCC;"><span>规格：</span><font title="{{viewList.standardName}}">{{viewList.standardNameA}}</font></li>
                <li style="border: 1px solid #CCC;" ><span >型号：</span ><font title="{{viewList.modelName}}">{{viewList.modelNameA}}</font><li>
             </ul> -->
