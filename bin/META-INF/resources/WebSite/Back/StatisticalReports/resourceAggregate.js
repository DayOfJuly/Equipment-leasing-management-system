app.controller('resourceAggregateController', function($scope, $timeout, SYS_CODE_CON, sysCodeTranslateFactory, category, entSvc, proSvc, statisticsSvc, statisticsExportSvc, downloadExcelUrl) {
	...
	$scope.queryEquipmentData = function(){
		...
		statisticsSvc.queryStatisticsList({urlPath: 'Detail', Action:'recourcesCollect'}, $scope.equDtlQryBean, qSucc, qErr);
		/** 资源明细列表查询 end */
	};
	...
	$scope.exportExcel = function(){
		...
		statisticsExportSvc.Export({urlPath: 'Detail', Action: 'recourcesCollect'}, $scope.equDtlQryBean, exportSucc, exportErr);
		/** 导出资源明细excel end */
	};
