...
<ol class="breadcrumb">
	...
	<li style="font-size: 13px">信息发布明细</li>
</ol>
<div class="form-horizontal">
	...
	<div class="form-group" style="margin: 0px;">
		...
		<div class="col-xs-1" style="margin-left: -29px; width: 160px;">
			<select name="equPubType" class="form-control select-hover" ng-model="equDtlQryBean.equPubType" 
				ng-options="row.id_ as row.name_ for row in sysCodeCon.MESSAGE_TYPE" style="height: 22px;">
				<option value="">全部</option>
			</select>
	...
	<table class="table table-striped table-hover">
		<thead>
			<tr class="success">
				...
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">信息标题</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">发布单位</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">发布日期</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">所属省市</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">响应单位数</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">当前状态</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">成交日期</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">成交单位</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">预估金额（万元）</td>
			</tr>
		</thead>
		<tbody>
			<tr ng-repeat="row in equipmentList">
				...
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.standardNameEx"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.modelNameEx"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="ct.codeTranslate(row.pubType, 'MESSAGE_TYPE')"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.infoTitle"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.disOrgName"><!-- 获取数据集合后，需要处理后显示 -->
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.releaseDate"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;">{{row.onProvinceEx}}<span ng-show="row.onCityEx"> - </span>{{row.onCityEx}}<span ng-show="row.onDistrictEx"> - </span>{{row.onDistrictEx}}</td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.depResponseCount"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="ct.codeTranslate(row.state, 'STATE_EQU_STATE')"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.dealDate"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.depName"></td>
				<td style="white-space: nowrap; text-align: center; height: 22px; padding: 10px;" ng-bind="row.forecastSum"></td>
			</tr>
		</tbody>
	</table>
</div>
