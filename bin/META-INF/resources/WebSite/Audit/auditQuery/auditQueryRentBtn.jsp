...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="auditQueryRentId" tabindex="-1" role="dialog"
				...
				<div class="form-horizontal">
					...
					<div class="form-group" style="margin-top: -10px;">
						...
						<div class="col-sm-10 form-inline" style="word-break:break-all">
							<p id="detailedDescriptionHtml1" class="form-control-static" rows="3" style="width:85%"></p>
						</div>
					</div>
					...
					<div class="form-group" >
						...
						<div class="col-sm-10 form-inline">
							<div id="Pic4" class="col-sm-2 form-inline" ng-repeat="t in PicList">
							      <a href="{{PicUrl}}/{{t.PicName}}/{{t.PicType}}" class="thumbnail">
								<img style="width:100px; height:80px" ng-src="{{PicUrl}}/{{t.PicName}}/{{t.PicType}}"  ng-init="createLightBox4();"></a>
							</div>
						</div>
					</div>
