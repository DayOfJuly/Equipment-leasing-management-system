...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="auditQueryDemSalBtnId" tabindex="-1" role="dialog"
			...
			<div class="modal-body">
				<div class="form-horizontal" >
					<div class="form-group">
						<input type="hidden" ng-model="formParms.id" style="margin-top: -10px;"/>
					...
					<div class="form-group" style="margin-top: -10px;">
						...
						<div class="col-sm-10 form-inline" style="word-break:break-all">
							<p id="detailedDescriptionHtml4" class="form-control-static" rows="3" style="width:85%"></p>
						</div>
					</div>
