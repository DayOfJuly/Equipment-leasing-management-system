...
var app = angular.module('rentApp',['ngResource','unifyModule','myPagination']);
app.controller('rentController',function($scope,rentSvc){
	/*
	 *分页标签参数配置
	 */
...
<body style="background-color: #fff;" ng-app="rentApp" ng-controller="rentController">
	<div class="container">
	...
	<div class="container" style="margin-top: 10px">
		<ol class="breadcrumb">
			...
			<li style="font-size: 13px">出租信息</li>
		</ol>
	</div>
	
	<div class="container" style="margin-top: 10px" ng-init="queryRentInfo()">
			<div class="col-xs-12">
							...
							<table class="table table-striped">
								...
								<tbody>
									<tr ng-repeat="t in rentList">
										<td>{{$index+1}}</td>
										<td>出租</td>
										<td><a target="_bank" href="../Publish/ViewInfo.jsp?id={{t.dataId}}&infoType=1">{{t.infoTitle}}</a></td>
										<td>{{t.price}}</td>
										<td>{{t.rentDate}}</td>
