...
var app = angular.module('saleApp',['ngResource','unifyModule','myPagination']);
app.controller('saleController',function($scope,SaleSvc){
	/*
	 *分页标签参数配置
	 */
...
<body style="background-color: #fff;" ng-app="saleApp" ng-controller="saleController">
	<div class="container">
	<div ng-include src="'/WebFront/WebSite/Main/Top.jsp'" ></div>
	</div>
	
	<div class="container" style="margin-top: 10px">
		<ol class="breadcrumb">
			<li style="font-size: 13px">您的位置：首页</li>
			<li style="font-size: 13px">出售信息</li>
		</ol>
	</div>
	
	<div class="container" style="margin-top: 10px" ng-init="querySaleInfo()">
			<div class="col-xs-12">
							...
							<table class="table table-striped">
								...
								<tbody>
									<tr ng-repeat="t in saleList">
										<td>{{$index+1}}</td>
										<td></td>
										<td><a target="_bank" href="../Publish/ViewInfo.jsp?id={{t.dataId}}&infoType=2">{{t.infoTitle}}</a></td>
										<td>{{t.price}}</td>
										<td>{{t.rentDate}}</td>
	...
	<!-- 引入底文件 -->
	<div class="container" style="margin-top: 10px">
		<div ng-include src="'/WebFront/WebSite/Main/Bottom.jsp'" ></div>
	</div>
