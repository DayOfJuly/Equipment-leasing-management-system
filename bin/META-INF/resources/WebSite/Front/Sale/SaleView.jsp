...
<script type="text/javascript">
	var app = angular.module('saleviewApp', [ 'ngResource', 'unifyModule',
			'myPagination' ]);
	app.controller('saleviewController', function($scope,SaleSvc) {
		 ...
		 * 查询test数据
		 */
		$scope.querySaleviewData = function() {
			var www= document.getElementsByName("id");
			var newid = id.value;
			
			SaleSvc.unifydo({parm : newid}, qSucc, qErr);
			function qSucc(rec) {
				
				$scope.saleviewList = rec.content;
			}
			function qErr(rec) {
...
<body ng-app="saleviewApp" ng-controller="saleviewController"
	data-ng-init="querySaleviewData()">
    <div ng>
    </div>
	<ol class="breadcrumb">
		<%
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="panel panel-default">
									<div class="panel-heading">【出租】{{saleviewList.infoTitle}}</div>
									<div class="panel-body">设备归属：{{saleviewList.enterpriseName}}</div>
									<div class="panel-body">设备报价：{{saleviewList.price}}元</div>
									<div class="panel-body">最后更新：2015-05-15 14:29</div>
									<div class="panel-body">浏览次数：24</div>
									<div class="panel-body">设备状态： {{saleviewList.state}}</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-12 col-sm-6">
								<div class="panel panel-default" >
									...
									<div  align="center " style="padding:25px;" >
										{{saleviewList.detailedDescription}}
									</div>
								</div>
							</div>
						</div>
				...
				<div class="sidebar right-sidebar col-md-3">
					<div class="widget sidebar-widget widget-agents">
						<div class="panel panel-primary">
							...
							<div class="panel-body">联系地址：{{saleviewList.contactAddress}}</div>
						</div>
					</div>
					...
					<div class="widget sidebar-widget widget-properties">
						<div class="panel panel-primary">
							<div class="panel-heading">详细说明</div>
							<div class="panel-body">{{saleviewList.detailedDescription}}</div>
						</div>
					</div>
				</div>
			</div>
