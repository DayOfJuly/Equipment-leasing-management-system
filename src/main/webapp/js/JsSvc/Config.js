 ...
 * 
 */
var servicePath = "";//这是远程服务器上面的地址

app.constant('PicUrl',servicePath+"/Picture");

app.constant('downloadExcelUrl', servicePath+"/BusEquipmentStatisticsExport/Download/");
...
//外部员工信息
app.constant('perOutEmployeeUrl',servicePath+'/BG/Party/OutEmployee');
//设备资源
...
//设备参数维护
app.constant('BusEquParameterUrl',servicePath+"/BG/BusEquParameter");
//出租
...
//检查内部员工是否已经存在
app.constant('CheckEmployeeTrueOrFalseUrl',servicePath+"/BG/Party/CheckSysUser");
//检查外部员工是否已经存在 
app.constant('CheckEmployeeTrueOrFalseOutUrl',servicePath+"/BG/Party/GetVmappInfoByUserCode");
//统计报表
app.constant('StatisticsUrl',servicePath+"/BusEquipmentStatistics");
app.constant('StatisticsExportUrl',servicePath+"/BusEquipmentStatisticsExport");