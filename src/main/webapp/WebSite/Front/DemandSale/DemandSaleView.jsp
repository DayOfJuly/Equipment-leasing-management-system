	...
	app.controller('rentviewController', function($scope, rentSvc) {
		...
		$scope.queryRentviewData = function() {
			...
			function qSucc(rec) {
				...
				$scope.rentviewList = rec.content;
			}
			function qErr(rec) {
...
<body ng-app="rentviewApp" ng-controller="rentviewController"
	data-ng-init="queryRentviewData()">
    <div ng>
    </div>
	<ol class="breadcrumb">
		<%
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="panel panel-default">
									...
									<div class="panel-body">设备归属：{{rentviewList.enterpriseName}}</div>
									...
									<div class="panel-body">设备状态： {{rentviewList.state}}</div>
								</div>
							</div>
						</div>
						<div class="row">
