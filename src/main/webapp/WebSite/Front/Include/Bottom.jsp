...
<!-- <div class="down_k">
	<div class="down">
		<div class="pwllk">
			<img src="../../../media/images/lgh.png" />
		</div>
		<div class="dso bhod_a">
			<p>新闻公告</p>
			<a href="#">公司新闻 </a> <a href="#">通知公告 </a> <a href="#">行业资讯 </a>
		</div>
		<div class="dso dso_a">
			<p>采购信息</p>
			<a href="#">招标公告</a> <a href="#">竞争性谈判</a> <a href="#">询价采购</a> <a
				href="#">澄清补遗 </a> <a href="#">中标告示</a>
		</div>
		<div class="dso">
			<p>供应商园地</p>
			<a href="#">下载中心</a> <a href="#">交易须知</a> <a href="#">操作手册</a>
		</div>
		<div class="dso bhod">
			<p>快速入口</p>
			<a href="#">政策法规</a> <a href="#">网上专卖店</a> <a href="#">官方论坛</a> <a
				href="#">常见问题</a>
		</div>
		<div class="dso_j">
			<p>中铁鲁班微信号</p>
...
<div class="bord_foot">
	<div class="wopq">
		<a href="#">集团网站</a>| <a href="#">鲁班服务</a>| <a href="#"> 联系我们</a>| <a
			href="#">合作伙伴</a>| <a href="#"> 法律声明</a>| <a href="#"> 关于我们</a>| <a
			href="#">联系邮箱 crecgec@lubanec.com </a>
	</div>
	<p>©2013 中铁鲁班 All Rights Reserved 鲁班（北京）电子商务科技有限公司版权所有
		京ICP备14004333号 | 京ICP证151026号</p>
	<p>客服电话:400-6988000 公司地址:北京市丰台区西客站南广场中盐大厦西塔8楼</p>
	<p>
		请使用IE9以上版本浏览页面，推荐使用<a href="#" class="col_slan">Chrome浏览器</a>以获得更好的用户体验！测试访问速度
	</p>
</div> -->