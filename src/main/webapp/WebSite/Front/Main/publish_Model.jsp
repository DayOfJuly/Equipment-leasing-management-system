				...
				<div class="modal-body">
					<div class="form-horizontal">
						...
						<div class="form-group" style="">
							...
							<label ng-show="show==2" contenteditable="false" class="col-xs-3 control-label" style="margin-left:52px;">成交单位类型：</label>
							<div class="col-xs-2" id="div_2"  ng-show="show==2">
								<select class="form-control select-hover" required ng-options="r.id_ as r.name_ for r in sysCodeCon.TYPE_EQU_STATE"  name="busState" ng-model="addPublishList.busState" ng-disabled="type" ng-click="suerClick(addPublishList.busState)" style="position: absolute; z-index:3;">
								    <option value="">请选择</option>
								</select>
							</div>
						...
						<div class="form-group" style="margin-top: -4px">
							<label  ng-show="show==2" contenteditable="false" class="col-sm-2 control-label">设备成交单位：</label>
							<div class="col-sm-4"  ng-show="show==2">
								<div class="input-group" ng-show="!userInfo.proId" >
									<input ng-show="name==2"  ng-model="equQryBean.orgName" type="text" maxlength="30" class="form-control" style="width: 115%;margin-top:8px; margin-left: 0; height: 34px; border-right: 0px; background-color: #fff;">
									<input ng-show="name==1" ng-model="addPublishList.depName" type="text" maxlength="30" class="form-control" style="width: 115%;margin-top:8px; margin-left: 0; height: 34px; border-right: 0px; background-color: #fff;">
									<div style="margin-left:112%"  ng-show="sh">
								  ...
								  <!-- <input data-toggle="dropdown" ng-model="addPublishList.depName" type="text" id="depName" name="depName" required class="form-control" maxlength="200"  />
								  <input type="text"  style="display:none"/> -->
							</div>
							<span  ng-show="show==2" class="" style="color: red; margin-top:18px;margin-left:-85px;float:left">*</span>
