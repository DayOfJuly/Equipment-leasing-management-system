...
<!-- 添加、修改-模态框（Modal）-->
<div class="modal fade" id="rentCheckAddId" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					<div class="form-horizontal">
						<div class="form-group" style="margin-top: -10px">
							...
							<div class="col-sm-4">
								<h5 style="font-family: Microsoft YaHei!important;">{{userInfo.code}}-{{addPublishList.equNo}}</h5>
							</div>
						...
						<div class="form-group" style="margin-top: -20px">
							...
							<div class="col-xs-2" id="div_2">
								<select class="form-control select-hover" required ng-model="addPublishList.busState" name="busState" style="position: absolute; z-index:3;">
									...
									<option value="3">局内租</option>
									<option value="4">外局租</option>
						...
						<div class="form-group" style="margin-top: -4px">
							...
							<div class="col-sm-4">
							 ...
							 <span class="" style="color: red; margin-top:9px;float:left">*</span>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea style="resize: none;"class="form-control" rows="3" maxlength="60" placeholder="请输入字符在60个以内" ng-model="addPublishList.note"/>
							</div>
						</div>
					</div>
				</div>
