...
<!-- 选择单位/项目（Modal） -->
<div class="modal fade" style="position: absolute; z-index:10031; overflow: hidden; top: 10%;" id="equAtEmployerModel"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" z-index="10031" aria-hidden="true">
