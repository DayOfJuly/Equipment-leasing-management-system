app.controller('messageDetailController', function($scope, $timeout, SYS_CODE_CON, sysCodeTranslateFactory, category, entSvc, proSvc, statisticsSvc, statisticsExportSvc, downloadExcelUrl) {
	...
	$scope.queryEquipmentData = function(currentPage){
		...
		statisticsSvc.queryStatisticsList({urlPath: 'Detail', Action:'Info'}, $scope.equDtlQryBean, qSucc, qErr);
		/** 资源明细列表查询 end */
	};
	...
	$scope.exportExcel = function(){
		...
		statisticsExportSvc.Export({urlPath: 'Detail', Action: 'Info'}, $scope.equDtlQryBean, exportSucc, exportErr);
		/** 导出资源明细excel end */
	};
