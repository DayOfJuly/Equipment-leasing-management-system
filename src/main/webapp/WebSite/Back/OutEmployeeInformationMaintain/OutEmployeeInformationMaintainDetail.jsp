					...
					<div class="form-horizontal" style="margin-top: -20px;">
						<ul>
							...
							<div class="form-group">
								<label contenteditable="false" class="col-xs-2 control-label" style="margin-top: -1.4%;">企业名称：</label>
								<div class="col-xs-4" style="text-align: left;">
									<p class="form-control-static" style="margin-top:-2%;">{{employeeEntityAdd.deptName}}</p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label contenteditable="false" class="col-xs-2 control-label" style="margin-top: -1.2%;">授权功能：</label>
								<div class="col-xs-6" style="margin-top:-1.4%">
									<div class="col-xs-6" style="text-align: left;" ng-repeat="authorityEntity in employeeEntityAdd.funInfo" style="margin-left: -4%;margin-top: -2.6%;">
										<p class="form-control-static" style="text-align: left;margin-top:5%;margin-left: -7%;">{{authorityEntity.funNote}}</p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label contenteditable="false" class="col-xs-2 control-label" style="margin-top: -1.4%;">备注：</label>
