app.controller('DemandInfoPubScreeningController', function ($scope,$timeout,$route,DemandRentSvc, regionSvc, category, published) {
	function qSucc(rec){
	...
	$scope.queryClassify=function(obj){
	 ...
	 $scope.DubCofim = function(){
		 ...
		 window.location.href="/WebSite/Mobile/Index.jsp#/DemandInfopublish";
	 }
