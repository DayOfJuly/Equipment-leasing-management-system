...
<div class="container">
   ...
   <!--  <div class="col-md-12 column" style="margin-top:20%">
    ...
    <div class="col-xs-4" >
			...
			<div class="col-xs-1">
				<a href="/WebSite/Mobile/Index.jsp#/DemandInfopubScreeningequipment"><p style="float: right;margin-top: -8%"" > <span class="glyphicon glyphicon-filter"></span></a>
    ...
    <div class="modal-dialog" style="margin-top:10%;width: 95%;">
        <div class="modal-content">
            <div class="modal-header">
            	<h4>请选择或填写：品牌、型号、规格<button type="button" class="btn btn-link  "   data-dismiss="modal"><span  class="glyphicon glyphicon-remove " ></span></h4>
            </div>
