...
<div class="navbar navbar-default navbar-fixed-top" style="border-bottom:1px solid #ddd; background-color:#fff;">
	...
	<div class="row" style="margin-top:-10px">
		 <div class="col-xs-3 text-center">
       	...
       	<div class="col-xs-3 text-center">
				<span ng-show="myVar" ng-click="toggle(4)">求购 <span class="glyphicon glyphicon-chevron-down"></span></span>
				<span ng-show="revel" ng-click="toggle(4)">求购 <span class="glyphicon glyphicon-chevron-up"></span></span>
...
<div class="container"  style="margin-top:130px;" >
		<ul class="media-list">
			<li class="media col-xs-12" style="margin-top:5px;" ng-repeat="r in DemandSaleList" id="demanList">
				<div>
					<a class="media-left" href="" ng-click="jump(this);" style="text-decoration:none"  >
							<div style="height:80px">
								<span>【求购】{{r.infoTitle}}</span><br>
