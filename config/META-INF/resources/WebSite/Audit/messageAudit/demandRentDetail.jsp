...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="demandRentDetailModalId" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" style="width: 950px;word-break:break-all;">
		<div class="modal-content">
			...
			<div class="modal-footer" style="margin-top: -10px">
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="通过" ng-click="submit('demandRentDetailModalId');"/>
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="退回" ng-click="openOpinionModal();"/>
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="删除" ng-click="delectAudit('demandRentDetailModalId');"/>
