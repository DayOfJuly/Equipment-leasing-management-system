...
<div class="navbar navbar-default navbar-fixed-top" style="border-bottom:1px solid #ddd; background-color:#fff;">
	...
	<div class="row" style="margin-top:-10px">
		 <div class="col-xs-3 text-center">
       	...
       	<div class="col-xs-3 text-center">
				<span ng-show="myVar" ng-click="toggle(3)">求租<span class="glyphicon glyphicon-chevron-down"></span></span>
				<span ng-show="revel" ng-click="toggle(3)">求租 <span class="glyphicon glyphicon-chevron-up"></span></span>
...
<div class="container"   style="margin-top:130px;">
		<ul class="media-list">
			<li class="media col-xs-12" style="margin-top:5px;" ng-repeat="r in DemandRentList" id="demandRent">
				<div>
					<a class="media-left" href="" ng-click="jump(this);" style="text-decoration:none"  >
							<div style="height:80px">
								<span>【求租】{{r.infoTitle}}</span><br>
