...
<div class="container"  style="margin-top:70px;margin-bottom:70px">
	<div class="row "  >
		<div class="col-md-12 column">
			<h3 class="text-left">
				【求购】{{viewList.infoTitle}}
			</h3>
			<ul class="list-unstyled">
				<li>
					单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价:<b>{{viewList.price}}</b>元（数量:<span>{{viewList.quantity}}</span>个）
				</li>
				<li>
				设备使用地点:{{viewList.price}}
				</li>
				<li>
					详细地址:{{viewList.atCity}}
				</li>
				<li>
					设备状态:{{viewList.address}}
				</li>
				<li>
					意向出售人:{{dealCount}}<span ng-if="dealCount==''" class="col_chen txt14">0</span>人
				</li>
