...
<div class="container">
	<div class="navbar navbar-default navbar-fixed-top" style=" padding:5px;">
		<div class="navbar-inner" style="height: 39px">
			<div class="container">
				<div class="navbar-header text-center col-xs-12">
					<h4>
						<a href="/WebSite/Mobile/Index.jsp#/DemandInfoPubprovinces"><small><span class="glyphicon glyphicon-chevron-left pull-left"></span></small></a>
						所在城市
					</h4>				
				</div>
			</div>
    ...
    <div class="col-md-12 column" style="margin-top:15%">
     ...
     <div class="col-md-12 column" >
        <a href="/WebSite/Mobile/Index.jsp#/DemandInfoPubdistrict" style="text-decoration : none ">
        <div>
		<p><span style="color:black">邯郸市</span> <small><span class="glyphicon glyphicon-chevron-right pull-right"></span></small></p>
		</div>
		</a>
		<hr>
    </div>
