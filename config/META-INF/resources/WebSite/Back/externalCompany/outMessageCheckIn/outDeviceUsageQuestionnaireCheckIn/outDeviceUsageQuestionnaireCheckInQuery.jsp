...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="OutQueryId" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-footer" >	
				<div style="text-align: center;">
					<input type="button"  class="btn btn_Under btn-default" style="margin-top: -20px" value="返回" data-dismiss="modal"/>
				</div> 
			</div> 
		<!-- /.modal-content -->
	</div>
