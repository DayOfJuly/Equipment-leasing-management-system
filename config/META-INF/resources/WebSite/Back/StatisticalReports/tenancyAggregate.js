app.controller('tenancyAggregateController', function($scope, $timeout, SYS_CODE_CON, sysCodeTranslateFactory, category, entSvc, proSvc, statisticsSvc, statisticsExportSvc, downloadExcelUrl) {
	...
	$scope.queryEquipmentData = function(){
		...
		statisticsSvc.queryStatisticsList({urlPath: 'Collection', Action:'rentCollect'}, $scope.equDtlQryBean, qSucc, qErr);
		/** 资源明细列表查询 end */
	};
	...
	$scope.exportExcel = function(){
		...
		statisticsExportSvc.Export({urlPath: 'Collection', Action: 'rentCollect'}, $scope.equDtlQryBean, exportSucc, exportErr);
		/** 导出资源明细excel end */
	};
