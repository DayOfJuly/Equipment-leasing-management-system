					...
					<div class="form-horizontal" style="margin-top: 10px;">
						<ul>
								...
								<div class="col-xs-4">
							    	...
							    	<div class="dropdown">
									   <button type="button"  class="btn btn-default" id="dropdownMenu1" style="width:90%;float:left;text-align: left;" data-toggle="dropdown"> 
									   		<lable style="margin-left:8px">{{displayName}}</lable>
									   </button>
									   <ul  class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" id="parentOrgs"  style="width:90%;margin-top:35px">
									   	  ...
									   	  <li role="presentation"><a ng-click="chooseParentOrgM();">返回上级部门</a></li>
									      <li role="presentation">
									         <a role="menuitem" tabindex="-1"  
									         	ng-click="chooseChildOrgM(departEntity.parentOrgId,departEntity.parentOrgName)">
									         	{{departEntity.parentOrgName}}
									         </a>
									      </li>
									      <li role="presentation">
									         <a role="menuitem" tabindex="-1" 
									         	ng-repeat="parentOrg in parentOrgList" 
									         	ng-click="chooseChildOrgM(parentOrg.currOrgId,parentOrg.name)">
									         	{{parentOrg.name}}
									         </a>
									      </li>
									   </ul>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input type="text" name="deptName" class="form-control" style="width:90%;float:left;" ng-model="departEntity.name" required maxlength="50" ng-pattern="/^[\u4e00-\u9fa5_a-zA-Z0-9]+$/"></input>
							    	<p class="form-control-static" style="color:red;">*</p>
								</div>
							...
							<div class="form-group" >
								...
								<div class="col-xs-4" >
									<select class="form-control" name="departType" ng-model="departEntity.type" style="width:90%;float:left;" required>
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<textarea class="form-control" name="note" maxlength="60" rows="3" style="width:90%;float:left;" ng-model="departEntity.note" placeholder="请输入字符在60个以内"></textarea>	
								</div>
						...
						<input class="btn btn-primary" style="margin-left: 20px;" type="button" value="提交" ng-click="addDepartment(signForm);">
						<input class="btn btn-primary" style="margin-left: 20px;" type="button" value="返回" ng-click="closeWindowAdd();"></div>
				</form>
			</div>
		</div>
		<!-- /.modal-content -->
