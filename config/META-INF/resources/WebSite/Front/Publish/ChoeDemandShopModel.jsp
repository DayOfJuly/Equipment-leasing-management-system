	...
	<div class="mar_t15">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_hj">
			<tr>
				<th width="30%">生产厂家</th>
				<td>
					<select  style="width: 230px" class="sel_a marr15 span230" id="manufacturer" name="" ng-model="selectList.manufacturerId" ng-options="rec.parameterId as rec.name for rec in manufacturerList">
