...
<div id="returnId"></div>
	<div class="ihhatitle1">请选择或者填写：生产厂家、品牌、型号、规格</div>
	<div class="fbxx_top">
	...
	<div class="mar_t15">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_hj">
			<tr>
				<th width="30%">生产厂家</th>
				<td><select  style="width: 230px" class="sel_a marr15 span230" id="manufacturer" name="" ng-model="selectList.manufacturerId" ng-options="rec.parameterId as rec.name for rec in manufacturerList">
						<option value="">请选择</option>
					</select>
					<div>
						<a ng-click="manufacturer();" href=""  style="text-decoration: none; float: left;">全部</a>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td><select  style="width: 230px"
					class="sel_a marr15 span230" name="PayerAcNo" id="brandId"
					ng-options="rec.parameterId as rec.name for rec in queryEquBrandList"
					ng-model="selectList.brandS"
					ng-change="brandChange(selectList.brandS);">
						<option value="">请选择</option>
				</select>
					<div>
						<a ng-click="brandList();" href=""  style="text-decoration: none; float: left;">全部</a>
					</div>
					</td>
			</tr>
			<tr>
				...
				<td><select ng-show="modelSelectShow" style="width: 230px"
					class="sel_a marr15 span230" name="PayerAcNo" id="modelId"
					ng-model="selectList.modelS"
					ng-options="rec.parameterId as rec.name for rec in queryEquModelList"
			...
			<tr>
				...
				<td><select ng-show="standardSelectShow" style="width: 230px"
					class="sel_a marr15 span230" name="PayerAcNo" id="standardId"
					ng-model="selectList.standardS"
					ng-options="rec.parameterId as rec.name for rec in queryEquStandardList"
	...
	<div class="ihhaann">
		<a class="iehi_d left close_openwin" ng-click="addModelCancel();">关闭</a><a
			class="iehi_d left" ng-click="addModelSubimt(equList);">确认</a>
	</div>
