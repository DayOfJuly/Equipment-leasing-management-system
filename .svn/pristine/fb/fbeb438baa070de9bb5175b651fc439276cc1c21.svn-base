...
<div id="returnId"></div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td width="25%"><select class="sel_a marr15 span230"
					...
					ng-click="queryClassify(rec)">
						...
						<option value="{{rec.equCategoryId}}"
							...
							ng-click="">{{rec.equipmentCategoryName}}</option>
				</select></td>
				...
				<td width="29%"><input class="inpt_booom inpt_booom_pol"
					value="查询" type="submit" ng-click="queryCategoryDataA(1);" /></td>
			</tr>
		</table>
		<div class="clear"></div>
	...
	<input type="text" class="inpt_a inpt_o width50"
		 ng-show="categoryList.length!=0"  ng-model="inputModel.parm"
		maxlength="200"  />
		<a style="margin-left: 180px;" class="iehi_d left" href="####"
		ng-click="selectSubmit(equipment_obj,this,inputModel);">确认</a>
		<a style="margin-left: 5px"	class="iehi_d left close_openwin" href="####"
		ng-click="cancelSubmit();">关闭</a>
</div>
<div ng-include
	src="'../../../WebSite/Back/Publish/ChoeDemandShopModel.jsp'"></div>
</div>
