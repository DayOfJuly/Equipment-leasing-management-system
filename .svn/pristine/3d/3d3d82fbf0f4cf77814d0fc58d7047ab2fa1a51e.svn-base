...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="examineDetailModalId" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" style="width: 950px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-horizontal" style="margin-top: 30px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-10 form-inline">
							<p class="form-control-static" rows="3" style="width:85%">{{formParms.detailedDescription}}</p>
						</div>
					</div>
			...
			<div class="modal-footer">
				<input type="button" class="btn btn-primary" value="通过" ng-click="submit();"/>
