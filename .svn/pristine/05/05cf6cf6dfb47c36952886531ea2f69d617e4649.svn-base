...
<div class="navbar navbar-default navbar-fixed-top" style="border-bottom:1px solid #ddd; background-color:#fff;">
		...
		<div class="container">
			<div class="row" style="margin-bottom:20px;margin-top: 5px;">
					<div class="text-center col-xs-12">						
						...
						<div class="col-xs-9">
							<input type="text" id="custNamePre" name="custNamePre" class="form-control" ng-click="goToSearch();" ng-model="formParms.queryName" placeholder="请输入关键词检索" >
						</div>
	...
	<div class="row" style="margin-top:-10px">
		 <div class="col-xs-3 text-center">
				<a ng-click="returnList();">综合</a><span style="color:#D1D1D1;float:right;margin-right:-20px">|</span>
       	</div>
       	<div class="col-xs-3 text-center" >
				<span ng-show="myVar" ng-click="toggle(1);">出租 <span class="glyphicon glyphicon-chevron-down"></span></span>
				<span ng-show="revel" ng-click="toggle(1);">出租 <span class="glyphicon glyphicon-chevron-up"></span></span>
...
<div class="container"  style="margin-top:130px;"  >
		<ul class="media-list">
			<li class="media col-xs-12" style="margin-top:5px;" ng-repeat="r in czresultList" id="rentList">
				<div >
					<a class="media-left" href="" ng-click="jump(this);" style="text-decoration:none"  >
						...
						<img style="width:70px;height:100px;float:left;"  ng-src="{{PicUrlName}}/{{r.PicName}}/{{r.PicType}}" alt="list1">
							<div style="height:80px">
								<span>【出租】{{r.infoTitle}}</span><br>
								<span style="color:#D1D1D1">{{r.onProvince}}{{r.onCity}}{{r.onDistrict}}</span><br>
								<span style="color:#EEEE00">
									<p 	ng-show="r.priceType==1">￥{{r.price}}元/月</p>
			                        <p  ng-show="r.priceType==2">￥{{r.price}}元/天</p>
			                        <p  ng-show="r.priceType==3">￥{{r.price}}元/小时</p>
		                        </span>
							</div>
					</a>
