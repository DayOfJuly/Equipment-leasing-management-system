...
<div class="main">
  ...
  <tr>
    <td width="6%">信息类型： </td>
    <td width="12%"> 
    <select  class="sel_a" name="PayerAcNo" ng-model="dataTypeName" ng-click="size=1;">
    ...
    <td width="6%">设备状态：</td>
    <td width="13%">
     <select  class="sel_a" name="PayerAcNo" ng-model="equStateName" ng-click="size=1;" >
          <option value="">全部</option>
    ...
    <td width="6%">发布日期：</td>
    <td width="26%">
       <input  id="beginDateId"  ng-init="getBeforeDate();" ng-mouseleave="BeginOut();" ng-change="complienStart();" ng-model="queryData.beginDate" type="text" class="inpt_a jfdk inpt_o span126" />
       <span class="jfoiwp">-</span>
       <input    ng-init="getNowDateStr();" ng-mouseleave="EndOut();"  ng-change="complienEnd();" id="endDateId" type="text" class="inpt_a inpt_o span126" ng-model="queryData.endDate"/>
    </td>
       ...
       <thead>
        ...
        <tr  ng-repeat="p in KeyWordList|orderBy:'releaseDate':true">
          ...
          <td><a href="" style="text-decoration: none;color: blue;margin-left:5px;" ng-click="delPublish(p.id);">删除</a></td>
				...
				<div style="float: right;" ng-show="KeyWordList.length!=0">
				<tm-paginations conf="paginationConf"  style="margin-right:0px; " ></tm-paginations>
   				</div>
   <div class="clear"></div>
</div>
