...
<div class="login_bg" id="openwin2">
  ...
  <td width="9%"> </td>
    ...
    <td width="21%"> 
   <input   type="text" class="inpt_a inpt_o span230" ng-show="userInfo.orgLevel!=6" ng-model="userInfo.Name" maxlength="200"  ng-change="KeyWordQuery(userInfo.Name,'LiNumA_','one');" />
   <div ng-show="LiNumA_" class="input_xl" style="margin-left: 188px;width: 230px;margin-top: 63px;border: 1px #ededed solid;" >
    ...
    <td width="13%" ng-show="userInfo.orgLevel!=6">
     <input name="" type="checkbox" ng-show="userInfo.orgLevel!=6&&save_level!=3" value="" ng-model="searBean.isInclude" ng-click="queryallequiData(1);"/><p ng-show="userInfo.orgLevel!=6&&save_level!=3" style="color: black;margin-top: -33px;margin-left: 14px">包含下级单位</p>
    </td>
    <td width="6%">设备名称：</td>
    <td width="21%">
