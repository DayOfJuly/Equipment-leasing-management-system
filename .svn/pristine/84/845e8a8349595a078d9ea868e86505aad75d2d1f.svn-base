						...
						<ul>
							...
							<div class="form-group" style="    margin-top: -4px;">
								...
								<div class="col-xs-4" style="text-align:left;">
									<p   style="width: 90%; float: left;margin-top: 6px;margin-left: 11px;">{{employeeEntityAdd.orgName}}</p>
								</div>
							</div>
							...
							<div class="form-group" style="    margin-top: -4px;">
								...
								<div class="col-xs-4" >
									<input type="text" class="form-control" name="telephone" style="width: 90%; float: left;margin-top: 4px;" ng-model="employeeEntityAdd.mobile" required ng-minlength="11" maxlength="11" ng-pattern="/(^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?$)|(^((\(\d{3}\))|(\d{3}\-))?(1[358]\d{9})$)/">
									<p class="form-control-static" style="color: red;margin-left:-70px;">*</p>
