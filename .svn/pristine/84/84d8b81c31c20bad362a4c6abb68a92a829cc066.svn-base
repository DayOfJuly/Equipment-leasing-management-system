 ...
 * var sdf = new scrollDeleteFactory(); 创建对象
...
(function(root,doc){
	...
	root.scrollDeleteFactory=function(){
		this.point;
	};
	
	scrollDeleteFactory.prototype.scrollListener=function(obj){
		var _this = this;
		$('.swipe-delete li > a')
        ...
        .on('touchmove', function(e) {
            ...
            if(change < -10){
            	e.currentTarget.style.left = -68 + 'px';
            }else{
