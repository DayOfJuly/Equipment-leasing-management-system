...
<!-- 添加、修改-模态框（Modal） -->
<div class="modal fade" id="rentDetailModalId" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width: 950px;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">{{titleMsg1}}<button type="button" class="btn btn-link  "  style="margin-left: 833px" data-dismiss="modal"><span  class="glyphicon glyphicon-remove " ></span></button></h4>
			</div>
			<div class="modal-body">
				<div class="form-horizontal" style="margin-top: -10px;">
					...
					<div class="form-group" style="margin-top: -10px;">
						...
						<div class="col-sm-4 form-inline">
							<h5>{{formParms.price}}&nbsp;元/{{ct.codeTranslate(formParms.priceType,"UNIT_LEASETIME")}}</h5>
						</div>
					</div>
					...
					<div class="form-group" style="margin-top: -10px;">
						...
						<div class="col-sm-4 form-inline">
							<h5 ng-show="formParms.shortestLease!=999">{{formParms.shortestLease}}{{ct.codeTranslate(formParms.priceType,"UNIT_LEASETIME")}}</h5>
							<h5 ng-show="formParms.shortestLease==999">不限</h5>
						</div>
					...
					<div class="form-group" style="margin-top: -10px;">
						...
						<div class="col-sm-10 form-inline" style="margin-top: -10px;word-break:break-all">
							<span class="form-control-static" rows="3" style="width:85%" id="rePayM"  ></span>
						</div>
					</div>
					...
					<div class="form-group" >
						...
						<div class="col-sm-10 form-inline">
							<div id="Pic" class="col-sm-2 form-inline" ng-repeat="t in PicList">
							      <a href="{{PicUrl}}/{{t.PicName}}/{{t.PicType}}" class="thumbnail">
								<img style="width:100px; height:80px" ng-src="{{PicUrl}}/{{t.PicName}}/{{t.PicType}}"  ng-init="createLightBox();"></a>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer" style="margin-top: -10px;">
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="通过" ng-click="submit('rentDetailModalId');"/>
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="退回" ng-click="openOpinionModal();"/>
				<input type="button" class="btn btn-primary btn_Under" style="margin-top: -20px" value="删除" ng-click="delectAudit('rentDetailModalId');"/>
