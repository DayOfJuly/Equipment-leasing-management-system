...
//发布状态(资源管理-阴悦)
sysCode =[];
sysCode=[{"id_":"1","name_":"未发布"},{"id_":"2","name_":"出租发布中"},{"id_":"3","name_":"出售发布中"},{"id_":"4","name_":"租售发布中"}];
...
//状态(项目设置-阴悦）
sysCode =[];
sysCode=[{"id_":"0","name_":"开工"},{"id_":"2","name_":"完工"}];
...
//审核状态(审核查询-阴悦）
sysCode =[];
sysCode=[{"id_":"1","name_":"待审核"},{"id_":"3","name_":"审核通过"},{"id_":"4","name_":"审核拒绝"},{"id_":"5","name_":"审核废止"}];
...
//交易状态（巩国才）  
sysCode =[];
sysCode=[{"id_":"1","name_":"已成交"},{"id_":"2","name_":"未成交"},{"id_":"3","name_":"作废"}];
sysCodeCon.STATE_EQU_STATE = sysCode;

//交易状态（张雨波）  
sysCode =[];
sysCode=[{"id_":"1","name_":"已成交"},{"id_":"3","name_":"作废"}];
sysCodeCon.STATETYPE_EQU_STATE = sysCode;

//成交单位类型（巩国才）  
sysCode =[];
sysCode=[{"id_":"3","name_":"局内"},{"id_":"4","name_":"局外"},{"id_":"5","name_":"外单位"}];
sysCodeCon.TYPE_EQU_STATE = sysCode;
...
//租期单位（巩国才）  
sysCode =[];
sysCode=[{"id_":"1","name_":"天"},{"id_":"2","name_":"月"},{"id_":"3","name_":"小时"}];
sysCodeCon.UNIT_LEASETIME = sysCode;

//来源
sysCode = [];
sysCode = [{"id_": "1", "name_": "自有"}, {"id_": "2", "name_": "内租"}, {"id_": "3", "name_": "外租"}, {"id_": "4", "name_": "外协"}];
sysCodeCon.EQU_DTL_QRY_TYPE = sysCode;
//业务类型（内部单位）
sysCode = [];
sysCode = [{"id_": "1", "name_": "自有"}, {"id_": "2", "name_": "局内租"}, {"id_": "3", "name_": "外局租"}, {"id_": "4", "name_": "外租"}, {"id_": "5", "name_": "报废"}, {"id_": "6", "name_": "出售"}];
sysCodeCon.EQU_RENT_DTL_QRY_TYPE = sysCode;
//业务类型（外部单位）
sysCode = [];
sysCode = [{"id_": "1", "name_": "自有"}, {"id_": "4", "name_": "外租"}, {"id_": "5", "name_": "报废"}, {"id_": "6", "name_": "出售"}];
sysCodeCon.EQU_RENT_DTL_QRY_TYPE_OUT = sysCode;
/**
